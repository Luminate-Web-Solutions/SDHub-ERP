...
import { SyllabusDetailsDialogComponent } from '../syllabus/syllabus-details-dialog/syllabus-details-dialog.component';

@Component({
  selector: 'app-weekly-syllabus',
  templateUrl: './weekly-syllabus.component.html',
  styleUrl: './weekly-syllabus.component.css'
})
export class WeeklySyllabusComponent implements OnInit {
  ...
  handleEventClick(info: any) {
    ...
    if (entry) {
      ...
      this.dialog.open(SyllabusDetailsDialogComponent, {
        width: '500px',
        data: entry
      });
    }
